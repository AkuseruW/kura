...
- `kura-bare`: Kura `Server + Router` without scaffold middleware
...
bun run bench:run -- --tools oha --apps bun-raw,kura-bare,api-standard
bun run bench:run -- --tools bun --apps bun-raw,kura-bare,api-standard --endpoints all
